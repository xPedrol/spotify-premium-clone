            ...
            <div className={styles.headerContent}>
                ...
                <nav className={styles.nav}>
                    <ul className={styles.navUl}>
                        <li className={styles.navLi}><a>Premium</a></li>
                        <li className={styles.navLi}><a>Suporte</a></li>
                        <li className={styles.navLi}><a>Baixar</a></li>
                        <li className={styles.navLi}><a>|</a></li>
                        <li className={styles.navLi}><a>Inscrever-se</a></li>
                        <li className={styles.navLi}><a>Entrar</a></li>
                    </ul>
                </nav>
            </div>
        </header>
